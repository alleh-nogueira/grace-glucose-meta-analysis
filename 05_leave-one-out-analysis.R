...
as.data.frame() |>
transmute(
    "Study Leaft-Out" = model_meta$studlab,
    "Mean Difference in AUROC" = estimate,
    "Standard Error" = se,
    "P for Overall Effect" = pval,
    "P for Heterogeneity" = Qp,
    "I²" = I2
) |>
fasstr::write_results("table-s1-leave-one-out.xlsx", digits = 3)